...
client.services.seat.seatInfoSync.seatInfoSync({
    kgygishCd: 'SSK000', //興行会社コード
    yykDvcTyp: client.services.seat.seatInfoSync.ReserveDeviceType.EntertainerSitePC, //予約デバイス区分
    trkshFlg: client.services.seat.seatInfoSync.DeleteFlag.False, //取消フラグ
